...
MeteoShrooms uses ruff to automatically format code according to a set of predefined rules (see the section `[tool.ruff.format]` in https://github.com/networkscientist/meteoshrooms/blob/master/pyproject.toml[pyproject.toml] for the rules and the https://docs.astral.sh/ruff/formatter/[ruff documentation] for a detailed explanation).
